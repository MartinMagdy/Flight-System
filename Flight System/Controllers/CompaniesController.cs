...
namespace Flight_System.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "companynumber,name")] Companies companies)
        {
        ...
        [Authorize(Roles = "Admin")]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "companynumber,name")] Companies companies)
        {
            if (ModelState.IsValid)
            {
